...
```{r}
allHeatMap = plot_heatmap(m2, cluster_rows = TRUE, filename = "./outputPDFs/DiffExpOut/allDatasetPheatmap.pdf")
...
VSHeatMap = plot_heatmap(normGroupVS, genes = pl_genes_clust, cluster_rows = FALSE, 
                          ...
                          color=colorRampPalette(c("yellow", "black", "magenta"))(50),
