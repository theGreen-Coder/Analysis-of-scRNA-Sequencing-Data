...
df["N_4"] = getColSample("CON_ihtc")
df["S_1"] = getColSample("DS_2DS3")
df["S_2"] = getColSample("DS_DSP")
df["S_3"] = getColSample("DS_DS1")
...
with PdfPages(outputDirectory+'Differential Expression DESeq2'+arg+'.pdf') as pdf:
    ...
    # sc.pl.heatmap(adata, presMarkers, groupby="group", vmax=5, show=False)
