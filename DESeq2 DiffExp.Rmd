...
```{r}
Counts = read.delim("rawCountsDESeqPerCluster.csv", header = TRUE, row.names = 1, sep = ",")
```
...
```{r}
pdf(file = "./heatmapAllSignificantClusters.pdf", width = 10, height = 10)
...
```{r}
pdf(file = "./heatmapAllClusters.pdf", width = 6.5, height = 10)
